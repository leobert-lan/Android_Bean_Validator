...
public final class Types {
    ...
    Set<? extends Annotation> nextAnnotations(
            ...
            Class<? extends Annotation> validationQualifier) {
        if (!validationQualifier.isAnnotationPresent(ValidationQualifier.class)) {
            throw new IllegalArgumentException(validationQualifier + " is not a ValidationQualifier.");
        }
        if (annotations.isEmpty()) {
            return null;
        }
        for (Annotation annotation : annotations) {
            if (validationQualifier.equals(annotation.annotationType())) {
    ...
    static <T extends Annotation> T createValidationQualifierImplementation(final Class<T> annotationType) {
        ...
        if (!annotationType.isAnnotationPresent(ValidationQualifier.class)) {
            throw new IllegalArgumentException(annotationType + " must have @ValidationQualifier.");
        }
